...
parts = SchLib(tool=SKIDL).add_parts(*[
    Part(name='TPS61200',dest=TEMPLATE,tool=SKIDL,ref_prefix='IC',num_units=1,do_erc=True,footprint='modules:DRC',pins=[
        ...
        Pin(num='3',name='L',func=Pin.INPUT,do_erc=True),
        Pin(num='4',name='PGND',func=Pin.PWRIN,do_erc=True),
        Pin(num='5',name='VIN',func=Pin.PWRIN,do_erc=True),
        Pin(num='6',name='EN',func=Pin.INPUT,do_erc=True),
        Pin(num='7',name='UVLO',func=Pin.INPUT,do_erc=True),
        Pin(num='8',name='PS',func=Pin.INPUT,do_erc=True),
        Pin(num='9',name='GND',func=Pin.PWRIN,do_erc=True),
        Pin(num='10',name='FB',func=Pin.INPUT,do_erc=True),
    ...
    Part(name='PIC10F320',dest=TEMPLATE,tool=SKIDL,ref_prefix='IC',num_units=1,do_erc=True,footprint='modules:MC',pins=[
        ...
        Pin(num='8',name='RA3',func=Pin.INPUT,do_erc=True),
